    ...
    <div class="company-details-main-container display-flex-row">
        ...
        <div class="company-details-container display-flex-col" id="student-details-view">
            <div class="container-top display-flex-row">
                ...
                <form action="<?php echo URLROOT; ?>admin/updateUserAccountStatus/student/<?php echo $data['user_id'] ?>" method="POST">
            ...
            <div class="container-body">
                <!-- Update Form -->
                <form action="<?php echo URLROOT ?>admin/main-student-details/<?php echo $data['user_id']; ?>" method="POST">
